        ...
        foreach ($ingressos as $ingresso) {
            ...
            echo '<div class="page">';
                ...
                <!-- <p style="text-align: center;font-size: 10px"><?php echo $evento . ' - ' . date_format($dataE, 'd-m');?></p> -->
                    <p style="text-align: center;font-size: 11px"><?php echo $evento;?></p>
                    <?php echo "<img src='./logoFeijo.PNG' alt='' style='width: 145px;'>";?>
                    <p style="text-align: center;font-size: 11px">Local: Clube Estoril <br> Data: 12 de Agosto às 11h45</p>
                </div> 
                <div class="direita"> 
