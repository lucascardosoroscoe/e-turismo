                ...
                <div class="col-lg-5">
                    <div style="margin-top: 7em !important;" class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header">
                            ...
                            <p class="small text-center">Login exclusivo para produtores de eventos e promoters</p>
                            <?php echo $msg;?>
                        </div>
                        <div class="card-body">
                            <form action="login.php" method="POST">
                                ...
                                <div class="small text-center"><a href="https://ingressozapp.com/nao-recebi-ingresso/">Comprou um Ingresso? Acesse aqui!</a></div>

                            </form>
                        </div>
                        <div class="card-footer text-center">
                            <div class="small"><a href="../produtores/adicionar.php">Ainda não é registrado? Cadastre-se!</a></div>
                        </div>
                    </div>
                </div>
            </div>
