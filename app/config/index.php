            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header"><h3 class="text-center font-weight-light my-4">Editar Meu Usuário</h3>
                        <a href='desativar.php'><div class="btn btnAdd"><i class='fas fa-trash'></i> Desativar conta</div></a>
                    </div>
                        <div class="card-body">
