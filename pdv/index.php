                    ...
                    <div class="card-body">
                        ...
                        <div class="menuSelecaoGuias">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <a style="margin-bottom:10px;" class="btn btn-primary btn-block" href="../app/produtores/adicionar.php"><h6><i class='fas fa-user-plus'></i> Produtor - Inscrição no IngressoZapp</h6></a>
                                </div>
                                <div class="col-lg-4">
