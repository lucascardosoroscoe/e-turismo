<?php
    ...
    foreach ($ingressos as $ingresso) {
        ...
        $aux .= 't=P';
            ...
            echo ("<img style='width: 40%;margin-left: 30%' src='../getImagem.php?id=$idEvento'/><br>");
