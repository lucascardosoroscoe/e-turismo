        ...
        <div class="row shadow-lg rounded-lg justify-content-center mt-5" style="padding-top: 15px;">
            ...
            <div class="col-lg-7">
                <div class="card shadow-lg border-0 rounded-lg">
                    ...
                    <i class="fas fa-glass-cheers"></i>  Ingressos já trocados!!!
                    </div>
                    <div class="card-body">
                        <h2>Ingressos já trocados anteriormente, para pedir segunda via entre em contato abaixo. </h2> 
                        <br>
                        <?php
                            $texto  = 'Gostaria de solicitar minha segunda via do ingresso do Vintage, foi uma troca do STB';
                            $url = urldecode($texto);
                        ?>
